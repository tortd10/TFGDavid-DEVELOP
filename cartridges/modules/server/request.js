...
function getAddressObject(address) {
    ...
    if (address) {
        addressObject = {
            ...
            nation: address.countryCode.value,
            firstName: address.firstName,
            lastName: address.lastName,
            secondLastName: address.custom.secondLastName,
            ID: address.ID,
            postalCode: address.postalCode,
            alias: address.custom.alias,
            province: {
                displayValue: address.custom.province.displayValue,
                value: address.custom.province.value
            },
            raw: address
        };
    }
